...
exports.getPostsAnalytics = getPostsAnalytics;
const AYR_BASE = "https://app.ayrshare.com/api";
const API_KEY = process.env.AYRSHARE_API_KEY;
async function ayr(path, init = {}) {
    if (!API_KEY) {
